...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/app/weibo/index.php/Admin/Manager/upd/mg_id/4" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td>
                        <select name="mg_role_id">
                            ...
                            <?php if(is_array($rinfo)): foreach($rinfo as $key=>$v): ?><option value=""><?php echo ($v); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
