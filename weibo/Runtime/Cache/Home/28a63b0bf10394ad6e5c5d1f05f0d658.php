...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
            ...
            <div class="block box">
                ...
                <div class="usBox">
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="yw0" action="/app/index.php/Home/User/register" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="user_sex" type="hidden" value="" name="user_sex" />
                                            <span id="user_sex">
                                            <input id="user_sex_0" value="1" checked="checked" type="radio" name="user_sex" /> 
                                            <label for="user_sex_0">男</label>&nbsp;
                                            <input id="user_sex_1" value="2" type="radio" name="user_sex" /> 
                                            <label for="user_sex_1">女</label>&nbsp;
                                            <input id="user_sex_2" value="3" type="radio" name="user_sex" /> 
                                            <label for="user_sex_2">保密</label></span>                                
                                        </td>
                                    </tr>
                                    <tr>
                                        <!--dropDownList($model,$attribute,$data,$htmlOptions=array())-->
                                        <td align="right"><label for="user_xueli">学历</label></td>
                                        <td>
                                            ...
                                            </select>                                <div class="errorMessage" id=user_xueli_em_" style="display:none"></div>                            </td>
                                    </tr>
                                    <tr>
                                        <!--checkBoxList($model,$attribute,$data,$htmlOptions=array())-->
                                        <td align="right"><label for="user_hobby">爱好</label></td>

                                        <td>
                                            <input id="user_hobby" type="hidden" value="" name="user_hobby" />
                                            <span id="user_hobby">
                                            <input id="user_hobby_0" value="1" type="checkbox" name="user_hobby[]" /> 
                                            <label for="user_hobby_0">篮球</label>&nbsp;
                                            <input id="user_hobby_1" value="2" type="checkbox" name="user_hobby[]" /> 
                                            <label for="user_hobby_1">足球</label>&nbsp;
                                            <input id="user_hobby_2" value="3" type="checkbox" name="user_hobby[]" /> 
                                            <label for="user_hobby_2">排球</label>&nbsp;
                                            <input id="user_hobby_3" value="4" type="checkbox" name="user_hobby[]" /> 
                                            <label for="user_hobby_3">棒球</label>
                                            </span>                                
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA商城"><img alt="YONGDA商城" src="/app/weibo/Public/Home/images/di.jpg"></a>
            <div class="blank"></div>
        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/app/weibo/Public/Home/images/ecmoban_link.jpg" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="/app/weibo/Public/Home/images/yongda_logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
