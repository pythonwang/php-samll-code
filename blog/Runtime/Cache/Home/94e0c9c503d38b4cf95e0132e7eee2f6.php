...
<!--主体-->
	<div class='main'>
		...
		<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><dl>
				...
				<dd class='info'>
				<?php if($v['username'] != null): ?><span class='time'>作者：<?php echo ($v["username"]); ?>&nbsp;&nbsp;&nbsp;发布于：<?php echo (time_format($v["time"])); ?></span>
					<?php else: ?>
					<span class='time'>作者：管理员&nbsp;&nbsp;&nbsp;发布于：<?php echo (time_format($v["time"])); ?></span><?php endif; ?>
