...
<div id="content">
	<form id="shopForm" action="<?php echo U('Shop/runedit',array('shopid' => $edshop['shopid']));?>" method="post">
	<table class='table table-striped table-bordered'>
		...
		<tbody>
			<tr>
				<td>商铺名称</td>
				<td>
					<input type="text" name="shopname"  value="<?php echo ($edshop["shopname"]); ?>"/>
				</td>
			</tr>
			<tr>
				<td>商铺地址</td>
				<td>
					<input type="text" name="shopaddress"  value="<?php echo ($edshop["shopaddress"]); ?>"/>
				</td>
			</tr>
			<tr>
				<td>地铁地址</td>
				<td>
					<input type="text" name="metroaddress" value="<?php echo ($edshop["metroaddress"]); ?>"/>
				</td>
			</tr>
			<tr>
				<td>商铺电话</td>
				<td>
					<input type="text" name="shoptel" value="<?php echo ($edshop["shoptel"]); ?>"/>
				</td>
			</tr>
			<tr>
				<td>商铺坐标</td>
				<td>
					<input id="shopcoord" name="shopcoord" type="text" value='<?php echo ($edshop["shopcoord"]); ?>'/>
