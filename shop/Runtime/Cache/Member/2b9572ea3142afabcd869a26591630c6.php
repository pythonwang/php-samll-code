...
<div id="main">
	<div class='left'>
		...
		<div class='baseinfo'>
			<dl><dt>手机号： </dt><dd><?php echo ($user["phone"]); ?></dd><span></span></dl>
			<dl><dt>邮　箱： </dt><dd><?php echo ($user["email"]); ?></dd></span></dl>
			<dl><dt>用户名： </dt><dd><?php echo ($user["uname"]); ?></dd><span></span></dl>
			<dl><dt>密　码： </dt><dd><?php echo ($user["password"]); ?></dd><span></span></span></dl>
		</div>
			</div>
		</div>
	</div>
