...
<head>
	...
	<link rel="stylesheet" href="/app/weibo2/Public/Theme/<?php echo ($style); ?>/Css/sech_user.css" />
...
<!--==========内容主体==========-->
    ...
    <!--==========创建分组==========-->
        <div id='right'>
    		...
    		<?php if(isset($info)): ?><div id='content'>
    			<?php if($info): ?><div class='view_line'>
	                <strong>用户</strong>
                    <span>共搜索到<?php echo ($count); ?>条</span>
	            </div>
	            <ul>
	            	<?php if(is_array($info)): foreach($info as $key=>$v): ?><li>
						<dl class='list-left'>
							<dt>
								...
								<?php if($v['face80']): ?><img src="/app/weibo2/Uploads/<?php echo ($v["face80"]); ?>" width='80' height='80'/>
								<?php else: ?><img src="/app/weibo2/Public/Images/noface.gif
								" width='80' height='80'/><?php endif; ?>
							</dt>
							<dd>
    			...
    			<div style="text-align:center;padding:20px;"><?php echo ($pagelist); ?></div>
    			<?php else: ?>
