...
<head>
    ...
    <title>shiguang-首页</title>
    <link rel="stylesheet" href="/app/weibo2/Public/Theme/<?php echo ($style); ?>/Css/nav.css" />
    <link rel="stylesheet" href="/app/weibo2/Public/Theme/<?php echo ($style); ?>/Css/index.css" />
        ...
        <!--微博发布框-->
            <div class='send_wrap'>
                ...
                <div class='send_write'>
                    <form action="<?php echo U('sendWeibo');?>" method='post' name='uploadPic'>
            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        ...
                        <?php if($v['face']): ?><img src="
                            /app/weibo2/Uploads/<?php echo ($v["face"]); ?>" width='50' height='50'/>
                        <?php else: ?>
                        <img src="/app/weibo2/Public/Images/noface.gif"
                         width='50' height='50'/><?php endif; ?>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
            ...
            <!--头像-->
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        ...
                        <?php if($v['face']): ?><img src="/app/weibo2/Uploads/<?php echo ($v["face"]); ?>" width='50' height='50'/>
                        <?php else: ?><img src="
                            /app/weibo2/Public/Images/noface.gif
                        " width='50' height='50'/><?php endif; ?>
                    </a>
                </div>
                <div class="wb_cons">
