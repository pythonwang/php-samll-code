...
<head>
	...
	<link rel="stylesheet" href="/app/weibo2/Public/Theme/<?php echo ($style); ?>/Css/edit.css" />
    ...
    <script type='text/javascript' src='/app/weibo2/Public/Js/city.js'></script>
	<script type='text/javascript' src='/app/weibo2/Public/Js/edit.js'></script>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editFace');?>" method='post' enctype="multipart/form-data">
	    			<div class='edit-face'>
                        ...
                        <?php if($user['face180']): ?><img src="/app/weibo2/Uploads/<?php echo ($user["face180"]); ?>" width='180' height='180' id='face-img'/>
                        <?php else: ?><img src="/app/weibo2/Public/Images/noface.gif" width='180' height='180' id='face-img'/><?php endif; ?>
	    				<p><center>
