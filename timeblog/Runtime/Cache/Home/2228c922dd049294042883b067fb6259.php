...
<head>
    ...
    <link rel="stylesheet" href="/app/weibo2/Public/Theme/<?php echo ($style); ?>/Css/comment.css" />
   ...
   <script type='text/javascript' src='/app/weibo2/Public/Js/comment.js'></script>
    ...
    <!--=====中部=====-->
       <div id="middle" class='fleft'>
        ...
        <?php if(is_array($comment)): foreach($comment as $key=>$v): ?><dl>
                <dt>
                    <a href="<?php echo U('/' . $v['uid']);?>"><?php if($v["face"]): ?><img src="/app/weibo2/Uploads/<?php echo ($v["face"]); ?>" width='50' height='50'/><?php else: ?><img src="/app/weibo2/Public/Images/noface.gif" width='50' height='50'/><?php endif; ?></a>
                </dt>
                <dd>
