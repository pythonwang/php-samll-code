...
<head>
	...
	<title>TIMEWeiBo 后台管理中心</title>
	<link rel="stylesheet" href="/app/weibo2/Public/Admin/Css/index.css" />
	<script type="text/javascript" src='/app/weibo2/Public/Admin/Js/jquery-1.8.2.min.js'></script>
	<script type="text/javascript" src='/app/weibo2/Public/Admin/Js/index.js'></script>
	<base target="iframe" />
</head>
<body>
	<div id="top">
	...
	<div id='left'>
		...
		<ul class='option'>
			<li><a href='<?php echo U("System/filter");?>'>关键字过滤(暂无)</a></li>
			<li><a href='<?php echo U("System/index");?>'>网站设置(暂无)</a></li>
