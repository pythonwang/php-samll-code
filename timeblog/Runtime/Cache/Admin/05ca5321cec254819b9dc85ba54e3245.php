...
<head>
    ...
    <link rel="stylesheet" href="/app/weibo2/Public/Admin/Css/login.css" />
    <link rel="stylesheet" href="/app/weibo2/Public/Admin/Js/JqueryUI/jquery-ui-1.9.2.min.css" />
    <script type="text/javascript" src='/app/weibo2/Public/Admin/Js/jquery-1.8.2.min.js'></script>
    <script type="text/javascript" src='/app/weibo2/Public/Admin/Js/JqueryUI/jquery-ui-1.9.2.min.js'></script>
    <script type="text/javascript" src='/app/weibo2/Public/Admin/Js/login.js'></script>
</head>
<body>
    <div id='top'>
        <a href='http://www.houdunwang.com' target='_blank'>
            <img src='/app/weibo2/Public/Admin/Images/blogo.png' width='270' height='52'/>
        </a>
        <a href='/app/weibo2' class='home'>-微博首页-</a>
    </div>
    <div id='main'>
        <div id="login">
